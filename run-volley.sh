...
CONTAINER_NAME=opencode-volleyball
...
podman run -it \
    ...
    -v /home/dog/projects/opencode-docker/contexts/volley/.local/:/root/.local:rw \
    -v /home/dog/projects/volleyball-tournament-manager/:/app:rw \
    opencode opencode .
